...
import { ArrowRight, BrainCircuit, Sparkles, Target, Users } from "lucide-react";
  ...
  return <div className="catalog-page">
    ...
    <main>
      <section className="catalog-hero">
        <div className="hero-copy"><p className="hero-kicker"><Sparkles size={16} /> Aprende jugando y experimentando</p><h1>{platform.name}</h1><p>{platform.subtitle}</p><small>{platform.intro}</small><a href="#juegos" className="hero-action">Elegir mi primer desafío <ArrowRight size={18} /></a><div className="hero-benefits"><span><BrainCircuit/>Decisiones reales</span><span><Target/>Resultados inmediatos</span><span><Users/>Para jugar solo o en grupo</span></div></div>
