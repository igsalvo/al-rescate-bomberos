...
export const games: GameDefinition[] = [
  ...
  { id: "detective-datos", slug: "detective-datos", title: "Detective de datos", shortDescription: "Encuentra los elementos que no siguen el patrón.", fullDescription: "Elige una dificultad y detecta anomalías entre figuras cada vez más complejas.", icon: "🔎", duration: "1–2 min", mode: "individual", difficulty: "progressive", categories: ["Datos y decisiones"], enabled: true, learning: "La analítica de datos permite encontrar patrones y detectar elementos distintos." },
