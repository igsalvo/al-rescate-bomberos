...
export const gameInstructions: Record<string, GameInstructions> = {
  ...
  "detective-datos": { objective: "Encontrar todas las anomalías del desafío.", steps: ["Observa forma, relleno y movimiento.", "Selecciona cada elemento que rompe el patrón.", "Usa el contador para comprobar cuántas anomalías faltan."], tip: "En los niveles avanzados debes ignorar distracciones y comparar más elementos." },
  ...
  vivienda: { objective: "Estimar correctamente cinco viviendas ficticias.", steps: ["Aprende con tres ejemplos resueltos.", "Completa cinco rondas ajustando tu estimación.", "Compara cada respuesta y revisa la evaluación acumulada."], tip: "Ninguna característica explica por sí sola el valor completo." },
